...
class Frame6(Frame):
    ...
    def ver_creador(self):
        ...
        self.label_titulo_creador.config(font=('Arial',20,'bold'),background='#FFC0CB')
        self.label_titulo_creador.grid(row= 0, column=3,padx=10,pady=10)

        self.label_titulo_creador2= tk.Label(self,text= 'Nombre')
        self.label_titulo_creador2.config(font=('Arial',15,'bold'),background='#FFC0CB')
        self.label_titulo_creador2.grid(row= 1, column=2,padx=10,pady=10)

        self.label_titulo_creador3= tk.Label(self,text= 'Contacto')
        self.label_titulo_creador3.config(font=('Arial',15,'bold'),background='#FFC0CB')
        self.label_titulo_creador3.grid(row= 1, column=4,padx=10,pady=10)

        self.label_name_creador= tk.Label(self,text= 'Martín D Ambrosio')
        self.label_name_creador.config(font=('Arial',12,'bold'),background='#FFC0CB')
        self.label_name_creador.grid(row= 2, column=2,padx=10,pady=10)


        self.label_correo_creador= tk.Label(self,text= 'martingermandambrosio@gmail.com')
        self.label_correo_creador.config(font=('Arial',12,'bold'),background='#FFC0CB')
